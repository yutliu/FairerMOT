...
import FairMOT.src.lib.datasets.dataset.jde as datasets
...
def main(opt, data_root='/home/dl/Data/MOT16/train', det_root=None, seqs=('MOT16-05',), exp_name='demo',
         save_images=False, save_videos=False, show_image=True):
    logger.setLevel(logging.INFO)
    result_root = os.path.join(data_root, '..', 'results', exp_name)
    result_root = os.path.join(r'/home/liuyuting/Code/FairMOT_single/results/test', exp_name)
...
if __name__ == '__main__':
    opt = opts().init()
    cur_model_path = opt.load_model
    os.environ['CUDA_VISIBLE_DEVICES'] = opt.gpus_str
    (_, tempfilename) = os.path.split(cur_model_path)
    (cur_model, _) = os.path.splitext(tempfilename)
