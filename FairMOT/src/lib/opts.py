...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--load_model', default='/home/liuyuting/Code/FairMOT_single/models/model_HOA.pth',
                             help='path to pretrained model')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/home/dl/Data/')
